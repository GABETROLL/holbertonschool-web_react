...
describe('<CourseList />', () => {
  ...
  it('renders correctly when given an empty `listCourses` or none at all', () => {
    const expectedHtml = (
      `<table id="CourseList">\
<thead><tr><th colSpan="2">Available courses</th></tr><tr><th>Course name</th><th>Credit</th></tr></thead>\
<tbody><tr><td>No course available yet</td><td></td></tr></tbody>\
</table>`
    );
  ...
  it("renders correctly when it's given a correct `listCourses` that's not empty", () => {
    const expectedHtml = (
      `<table id="CourseList">\
<thead><tr><th colSpan="2">Available courses</th></tr><tr><th>Course name</th><th>Credit</th></tr></thead>\
<tbody><tr><td>ES6</td><td>60</td></tr><tr><td>Webpack</td><td>20</td></tr><tr><td>React</td><td>40</td></tr></tbody>\
</table>`
    );
